...
function baseProject(overrides: Partial<ProjectRow> = {}): ProjectRow {
  return {
    ...
    location_input_path: '/home/asrin/Desktop/demo',
    location_canonical_path: '/home/asrin/Desktop/demo',
    location_allowed_root: '/home/asrin/Desktop',
    location_accessible: true,
    location_checked_at: new Date(),
    repo_present: true,
    repo_top_level_path: '/home/asrin/Desktop/demo',
...
function validScan(overrides: Partial<Extract<RunnerInspectResult, { valid: true }>> = {}): RunnerInspectResult {
  return {
    ...
    git: {
      present: true,
      topLevelPath: '/home/asrin/Desktop/demo',
